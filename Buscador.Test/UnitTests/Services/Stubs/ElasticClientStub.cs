...
namespace Buscador.Test.UnitTests.Services.Stubs
{
	...
	{
		public IConnectionSettingsValues ConnectionSettings => throw new NotImplementedException();
		...
		public Task<OpenPointInTimeResponse> OpenPointInTimeAsync(Indices index, Func<OpenPointInTimeDescriptor, IOpenPointInTimeRequest> selector = null, CancellationToken ct = default)
		{
			throw new NotImplementedException();
		}
